<nav x-data="{ open: false }" class="bg-white lg:bg-red-900 xl:bg-red-900 md:bg-red-900">
    <!-- Primary Navigation Menu -->
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex h-16 {{auth()->check() && auth()->user()->admin == true ? 'justify-between' : ' lg:justify-center justify-between'}}">
            <div class="flex">
                <!-- Logo -->
                ...
                <div class="relative ml-3">
                    <x-jet-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            ...
                            @else
                                <span class="inline-flex rounded-md">
                                    <button type="button" class="inline-flex items-center px-3 py-2 text-sm font-medium leading-4 text-white transition duration-150 ease-in-out bg-red-900 border border-transparent rounded-md hover:text-yellow-300 focus:outline-none">
                                        {{ Auth::user()->name }}
